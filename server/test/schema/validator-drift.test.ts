...
const VALIDATORS: Record<string, z.ZodTypeAny> = {
  ...
  CreateManualEventArgs: CreateManualEventInput,
  ...
  RegisterPushSubscriptionArgs: RegisterPushSubscriptionInput,
  ReorderProjectNotesArgs: ReorderProjectNotesInput,
  SkipHabitArgs: SkipHabitInput,
  UpdateActivityTypeArgs: UpdateActivityTypeInput,
  UpdateHabitArgs: UpdateHabitInput,
  UpdateManualEventArgs: UpdateManualEventInput,
  UpdateNotificationPreferencesArgs: UpdateNotificationPreferencesInput,
